      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/simple-order/dashboard"
          ...
          <div>
                    ...
                    <div className="absolute top-16 left-0 bg-white border border-neutral-200 rounded-2xl p-3 shadow-xl z-10 grid grid-cols-6 gap-1 w-64">
                      {EMOJI_OPTIONS.map(e => (
                        <button key={e} onClick={() => { setNewProduct(p => ({ ...p, emoji: e })); setShowEmojiPicker(false) }}
                          className="w-9 h-9 text-xl hover:bg-neutral-100 rounded-lg transition flex items-center justify-center">
                          {e}
                        </button>
                      ))}
                    </div>
            ...
            <div className="flex gap-3">
              <button onClick={() => setStep(1)}
                className="px-6 py-4 rounded-2xl font-bold text-neutral-500 hover:bg-neutral-100 transition">
                ← 이전
              </button>
              <button
          ...
          <div>
            ...
            <div className="bg-neutral-50 rounded-3xl border border-neutral-200 p-6 sm:p-8 mb-8">
              ...
              <div className="bg-white rounded-2xl border border-neutral-100 p-6">
                ...
                {products.length > 4 && (
                  <p className="text-xs text-neutral-400 mt-3 text-center">+{products.length - 4}개 더</p>
                )}
              </div>
            </div>
            ...
            <div className="bg-white border border-neutral-100 rounded-2xl p-6 mb-8">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-neutral-500">가게 이름</span>
                  <span className="font-bold text-neutral-900">{store.name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-500">업종</span>
                  <span className="font-bold text-neutral-900">{store.type}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-500">등록 상품</span>
                  <span className="font-bold text-neutral-900">{products.length}개</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-500">주문 페이지</span>
                  <span className="font-bold text-blue-600">{store.slug}.simpleorder.kr</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-bold text-lg transition shadow-lg shadow-blue-600/20"
              >
                🚀 주문 페이지 만들기
              </button>
            </div>
